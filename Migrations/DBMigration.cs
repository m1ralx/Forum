    ...
    public partial class DBMigration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.ForumThreads", t => t.Thread_Id)
                .Index(t => t.Owner_Id)
                .Index(t => t.Thread_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ForumThreads", "Owner_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.Messages", "Thread_Id", "dbo.ForumThreads");
            DropForeignKey("dbo.Messages", "Owner_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.ForumThreads", "Board_Id", "dbo.Boards");
            ...
            DropIndex("dbo.ForumThreads", new[] { "Owner_Id" });
            DropIndex("dbo.ForumThreads", new[] { "Board_Id" });
